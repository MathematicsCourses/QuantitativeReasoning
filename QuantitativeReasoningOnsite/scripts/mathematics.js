...
function gradeMLM(event) {
    ...
    var weightOneA1st = parseFloat(document.getElementById("weightOneA1st").value, 10) || 0,
        ...
        + weightEightA
        + weightNineA1st + weightNineA2nd
        + weightNineB1st + weightNineB2nd
        + weightNineC1st + weightNineC2nd
        ;
        ...
        + weightedScoreEightA
        + weightedScoreNineA1st + weightedScoreNineA2nd
        + weightedScoreNineB1st + weightedScoreNineB2nd
        + weightedScoreNineC1st + weightedScoreNineC2nd
        ;
